  ...
  <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
    ...
    <div class="row">
        <form role="form" action="SeTest.php" method="post">
            <div class="col-lg-6">
               <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Smoke Testing</strong></div>
               <div class="form-group">
                    
                    <div class="input-group">
                        <input type="text" class="form-control" id="InputCustNameFirst" name="vehi_no" placeholder="Vehicle Number" required>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="odo_value" id="InputName" placeholder="Odometer Value" required>
                    </div>
                </div>
               <div> <input type="submit" name="submit" id="submit" value="Submit" class="btn btn-info bottom-left"></div>
